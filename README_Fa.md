...
> میخای داکیومنت انگلیسی رو بخونی؟ بزن روش[**English Guide**](./README.md)
...
> 📌 **نکته:** اگه `curl` از پیش، روی روترت نصب شده، استفاده از دستور `curl` پیشنهاد میشه! وگرنه، از `wget` رو بزن تو کار!
